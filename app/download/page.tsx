      ...
      <main className="pt-20">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute -top-24 sm:-top-40 -right-40 w-80 h-80 bg-primary/20 rounded-full blur-[100px]" />
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {FEATURES.map((feature) => (
              <div
                key={feature.title}
                className="group bg-gray-900 border border-gray-800 rounded-2xl p-6 hover:border-gray-700 transition-colors"
              >
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
          <div className="max-w-2xl mx-auto">
            <div className="bg-gradient-to-br from-primary/10 to-blue-600/10 border border-primary/20 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-400">
                A modern POS solution designed for mobile merchants, food trucks,
                and event vendors
              </p>
            </div>
          </div>
