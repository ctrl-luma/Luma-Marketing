          ...
          <div className="bg-gray-950 rounded-b-lg sm:rounded-b-xl border border-gray-800 border-t-0 p-4 sm:p-6 md:p-8">
            ...
            <div className="bg-gray-900/50 rounded-lg sm:rounded-xl border border-gray-800 overflow-hidden">
              ...
              <div className="divide-y divide-gray-800">
                {[
                  { item: 'Espresso Martini x2', amount: '$28.00', time: 'Just now', status: 'success' },
                  { item: 'Margarita', amount: '$14.00', time: '2 min ago', status: 'success' },
                  { item: 'Old Fashioned x3', amount: '$48.00', time: '5 min ago', status: 'success' },
                ].map((tx, i) => (
                  <motion.div
                    key={i}
