        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              {/* Floating elements - Desktop: positioned beside phone, Mobile: below phone */}
              ...
              {/* Mobile floating badges - horizontal row below phone */}
              <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.8, duration: 0.5 }}
                className="lg:hidden absolute -bottom-20 sm:-bottom-24 left-1/2 -translate-x-1/2 flex gap-2 sm:gap-3"
              >
                <div className="bg-gray-900/90 backdrop-blur-sm rounded-lg px-3 py-2.5 sm:px-4 sm:py-3 shadow-xl border border-gray-800 min-w-[130px] sm:min-w-[150px]">
